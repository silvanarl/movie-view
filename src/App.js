...
import { getPopularMovies } from "./API/get";
      ...
      <div className="general-bgc-col">
        ...
        <main>
          <Switch>
            <Route exact path="/">
              {popMovie.length > 0 && (
                <Home popMovie={popMovie} setPopMovie={setPopMovie} initialPopMovie={initialPopMovie}
                setInitialPopMovie={setInitialPopMovie}/>
              )}
            </Route>
            <Route exact path="/:id">
